          ...
          {projects.map((project, i) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <svg
                  className="w-5 h-5 text-zinc-600 group-hover:text-blue-400 transition-[color,transform] group-hover:-translate-y-0.5 group-hover:translate-x-0.5 shrink-0 mt-1"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
                  viewBox="0 0 24 24"
